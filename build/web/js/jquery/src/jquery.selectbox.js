        ...
        $(this).each(function() {
            ...
            function loadSB() {
                ...
                if(!$orig.is(":disabled")) {
                    ...
                    $items.filter(".disabled").find("a").click(function() {
                        return false;
                    });
