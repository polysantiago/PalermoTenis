                        ...
                        if(!this.options.nested){
                            ...
                            if(this.options.maxLevels <= level+childlevels){
                                ...
                                if(!$.ui.isOverAxis(this.positionAbs.left, i.left, i.width)){
                                    ...
                                    if(i.item.find(this.options.nested).siblings().length<=0 && !i.item.hasClass("selectable")){	
                                        i.item.append($("<"+this.options.nested+">").css("display","block"));
                                    }

                                    if(i.item.hasClass("expandable")) i.item.find("span:first").click();
                                    ...
                                    if(this.options.maxItems.length <= level || (i.item.children(this.options.nested).children(this.options.items).not(".ui-sortable-helper,.ui-sortable-placeholder").length < this.options.maxItems[level])){                                      
                                        if(this._hasChildNodes(i.item) || !i.item.hasClass("selectable"))
