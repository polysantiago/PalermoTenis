...
<html>
    <head>
        ...
        <script type="text/javascript" charset="ISO-8859-1" src="/admin/js/pack/pago/pago.pack.js"></script>
        <style type="text/css">
            #main {width: 400px;}
    ...
    <body>
        <div id="main">
            ...
            <div>
                <table class="list" align="center">
                    ...
                    <tbody>
                        ...
                        <s:iterator value="pagos" var="p" >
                            <tr val="<s:property value="#p.id" />" name="pagoId">
                                <td class="nombre">
            ...
            <div id="functions">
                ...
                <button id="btnAgregarNuevo">Agregar Forma de Pago</button>
            </div>
        </div>
    </body>
</html>
