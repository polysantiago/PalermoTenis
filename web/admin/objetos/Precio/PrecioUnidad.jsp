...
<html>
    <head>
        ...
        <title>Editar Precios por Unidad</title>
        ...
        <script type="text/javascript" charset="ISO-8859-1" src="/admin/js/pack/precio/precio.simple.pack.js"></script>
        <style type="text/css">
            #main {width: 700px;}
            #main table.list {width: 620px;}
                        ...
                        <s:iterator value="producto.precios" var="p">
                            <tr>
                                ...
                                <td class="cuotas" val="<s:property value="#p.id.cuotas" />" name="newCuotas">
                                    <s:textfield name="cuotas" value="%{#p.id.cuotas}" theme="css_xhtml" size="1" />
                                </td>
                                <td class="valor">
