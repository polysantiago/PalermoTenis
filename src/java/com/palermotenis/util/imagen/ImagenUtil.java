...
public class ImagenUtil {
    ...
    public static ImagenEscalada createImagenEscalada(File file, Imagen imagen, TipoImagen tipoImagen) throws IOException {            
            ...
            Iterator it = ImageIO.getImageWritersByFormatName(extension);
