...
var dependencies = ["jquery", "jquery.history", "jquery.treeview.async", "flash"];

define(dependencies, function($) {
	
	MM_preloadImages('images/agregar-over.gif','images/envio-over.gif','/images/ajax-loader-cotizacion.gif');
